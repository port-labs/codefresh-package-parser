...
docker tag codefresh-package-parser:latest public.ecr.aws/y8q1v8m0/codefresh-package-parser:1.0.0
...
docker push public.ecr.aws/y8q1v8m0/codefresh-package-parser:1.0.0
